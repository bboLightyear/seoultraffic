...
<div class="cs_write_wrap_all">
		<div class="cs_write_wrap_form">
			...
			<form action="noticeedit?sno=${content.sno }" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
				
				<div class="cs_write_wrap_form_title">
					<input type="text" class="cs_write_wrap_form_title_it" name="stitle" value="${content.stitle }" onfocus="clearInput(this)"/>
				...
				<div class="cs_write_wrap_form_wrap_content">
					<div class="cs_write_wrap_form_content">
						...
						<textarea type="text" class="cs_write_wrap_form_content_ta" name="scontent">
							${content.scontent }
						</textarea>
				...
				<script>// 사진 첨부 후에 첨부한 사진 리스트 나오도록 하는 스크립트
					function displayFileName(input) {
				        ...
				        if (files.length > maxFiles) {
				            alert("파일은 1개까지 업로드 가능합니다."); // 파일 수가 최대 값보다 많으면 알림 표시
